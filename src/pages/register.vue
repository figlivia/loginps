      ...
      <q-page class="flex flex-center">
        ...
        >
          ...
          <q-card-section>
            ...
            >
              <img src="~/assets/logo-pa.png" />
            </q-avatar>
            <div class="row no-wrap items-center">
              <div class="col text-h6 ellipsis">Cadastro</div>
            </div>
          </q-card-section>
          <q-card-section>
            <q-form class="q-gutter-md">
              <q-input label="Nome Completo" lazy-rules />

              <q-input type="text" label="Nome da Mãe" />

              <q-input type="text" label="Nome da Mãe" />

              <div class="col text-h8 ellipsis" style="margin-top: 10px">
                Ainda não tem conta? <a href="#"><b>Cadastre-se</b></a>
              </div>
              <div class="col text-h8 ellipsis" style="margin-top: 10px">
...
.normal_gradient {
  background: linear-gradient(145deg, rgb(245, 246, 247) 15%, #e6e7e8 70%);
}
.dark_gradient {
